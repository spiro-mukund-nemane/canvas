...
import { ChevronRight, Circle, FolderPlus, Minus, Pencil, Square, Upload, X, Eye, EyeOff, GripVertical, Layers2 } from 'lucide-react';
...
export function CollapsibleLegend({
  ...
  const [uploadLayerDialogOpen, setUploadLayerDialogOpen] = React.useState(false);
      ...
      <div 
        className={`flex items-center gap-2 p-1 text-sm ${
          layer.id === selectedLayerId
            ? 'bg-blue-100 text-black font-semibold rounded-sm'
            : 'hover:bg-gray-100'
        }`}
